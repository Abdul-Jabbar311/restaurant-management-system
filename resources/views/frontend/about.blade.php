        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <p class="mt-8 text-lg text-orange-100 leading-8">
                    ...
                    We believe food is more than a meal.
                    It's an experience. Every dish is freshly
                    prepared using premium ingredients,
                    served with love and hospitality.
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <p class="mt-6 text-gray-600 leading-8">
                    ...
                    Since our beginning, we have served thousands
                    of customers with freshly prepared meals,
                ...
                <p class="mt-5 text-gray-600 leading-8">
                    ...
                    Whether you're visiting with family,
                    celebrating with friends,
                    or ordering online,
                    our mission is to provide
                    unforgettable food every single time.
