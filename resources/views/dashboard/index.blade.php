...
<div class="rd-font-body">
    ...
    <div class="relative overflow-hidden rounded-3xl bg-linear-to-br from-orange-500 via-red-500 to-pink-500 shadow-xl shadow-orange-200/50 mb-8 rd-animate">
        ...
        <div class="relative grid grid-cols-1 lg:grid-cols-5 items-center">
            ...
            <div class="lg:col-span-2 h-48 sm:h-64 lg:h-full relative">
                <img
                    src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=900&q=80"
                    alt="Freshly plated restaurant dish"
                    loading="lazy"
                    onerror="this.style.display='none'"
                    class="w-full h-full object-cover lg:rounded-r-3xl opacity-95"
                >
                <div class="absolute inset-0 bg-linear-to-l from-transparent to-orange-500/40 lg:rounded-r-3xl" aria-hidden="true"></div>
            </div>
